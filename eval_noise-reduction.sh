#bin/bash
for dir in NAACL2019/NAACL2019_Portuguese/*/; do
        echo "dir: $dir"
	singleModel="$(find $dir -name "model*.st")"
...
#	echo "$testFileName"
	...
	sep="-"
	suffix=".parsed.score"
	echo "==> $testFileName$sep$modelName$suffix <==" >> LAS_nd_dev.score
	echo "LAS F1 Score: $score" >> LAS_nd_dev.score
done
